...
function Products() {
  ...
  const { data: products, isLoading, isError } = useGetProductsQuery(searchValue);
  ...
  if (isError || !products?.data) return <div className="text-center text-red-500 py-5">Failed to load products</div>;
